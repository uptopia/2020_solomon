...
"""autogenerated by genpy from yolo_detection/ROI.msg. Do not edit."""
import codecs
import sys
...
class ROI(genpy.Message):
  _md5sum = "aac12b3583057ebcad7306916635123f"
  _type = "yolo_detection/ROI"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string object_name
int32 x
int32 y
"""
  __slots__ = ['object_name','x','y']
