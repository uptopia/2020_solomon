...
(cl:defmethod cl:initialize-instance :after ((m <ROI>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ROI)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolo_detection-msg:<ROI> is deprecated: use yolo_detection-msg:ROI instead.")))

(cl:ensure-generic-function 'object_name-val :lambda-list '(m))
(cl:defmethod object_name-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_detection-msg:object_name-val is deprecated.  Use yolo_detection-msg:object_name instead.")
  (object_name m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_detection-msg:x-val is deprecated.  Use yolo_detection-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ROI>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_detection-msg:y-val is deprecated.  Use yolo_detection-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ROI>)))
  ...
  "aac12b3583057ebcad7306916635123f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ROI)))
  "Returns md5sum for a message object of type 'ROI"
  "aac12b3583057ebcad7306916635123f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ROI>)))
  ...
  (cl:format cl:nil "string object_name~%int32 x~%int32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ROI)))
  "Returns full string definition for message of type 'ROI"
  (cl:format cl:nil "string object_name~%int32 x~%int32 y~%~%~%"))
