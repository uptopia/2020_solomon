...
def take_pic(): # 手動拍照                         
    try:
        while(True):
            ...
            key = cv.waitKey(1)
            if key & 0xFF == ord('s'):
                cv.imwrite('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/00.png',color_image_1)
                cv.imwrite('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/01.png',color_image_2)
...
def contours_demo(image,x,y):
    ...
    contours,hierarchy = cv.findContours(edge_output,cv.RETR_TREE,cv.CHAIN_APPROX_SIMPLE)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if start_input == 1:
            ...
            box_in_sence_1 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/00.png') # A處照片top 輸入圖檔
            box_in_sence_2 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/01.png',0) # A處照片bottom 輸入圖檔

            # 正面
            box_1 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/W/w_top2.png',0)
            box_2 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/R/r_top2.png',0)
            box_3 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/Y/y_top2.png',0)
            box_4 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/G/g_top2.png',0)
            box_5 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/W_P/wp_top2.png',0)
            box_6 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/G_P/gp_top2.png',0)
            # 反面
            box_7 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/W/w_bottom2.png',0)
            box_8 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/R/r_bottom2.png',0)
            box_9 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/Y/y_bottom2.png',0)
            box_10 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/G/g_bottom2.png',0)
            box_11 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/W_P/wp_bottom2.png',0)
            box_12 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/G_P/gp_bottom2.png',0)
            ...
            # print(AA)
            cv.imwrite('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/AA.png',AA)
            #   dep

            src2 = cv.imread('/home/robotarm/Documents/solomon_ws/src/pocky_detection/img/AA.png')
